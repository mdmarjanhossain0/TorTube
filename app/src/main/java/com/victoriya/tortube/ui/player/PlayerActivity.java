...
import static com.victoriya.tortube.ui.main.MainActivity.START_PLAYER_ACTIVITY;
...
public class PlayerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getData() != null) {
            mPrefs.updateMedia(Uri.parse(getIntent().getStringExtra(START_PLAYER_ACTIVITY)), getIntent().getType());
        }
